...
import { SvgFind, SvgSettings } from '../Asset/Icon/header/svg_header';
...
const SearchInput = styled.div`
    ...
    label:before {
        ...
        bottom: 0;
        width: 30px;
        background: url('https://d2ug3aglf1tff7.cloudfront.net/image/search.svg')
...
const SettingBtn = styled.div`
    ...
    width: 1.2vw;
    height: 1.2vw;
    background: url('https://d2ug3aglf1tff7.cloudfront.net/image/setting.svg')
        center / contain no-repeat;
`;
